...
RUN     wget http://mirror.cogentco.com/pub/apache/nifi/0.6.0/nifi-0.6.0-bin.tar.gz && \
            tar zxvf nifi-0.6.0-bin.tar.gz && \
            mv nifi-0.6.0 /home/nifi && \
            rm nifi-0.6.0-bin.tar.gz
